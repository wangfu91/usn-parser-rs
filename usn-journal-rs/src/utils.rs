...
mod tests {
    ...
    fn filetime_to_systemtime_test() -> anyhow::Result<()> {
        ...
        let expected = UNIX_EPOCH - std::time::Duration::from_secs(11644473600);
        ...
        unsafe {
            windows::Win32::System::Time::SystemTimeToFileTime(&st, &mut ft)
                .ok()
        ...
        let expected = UNIX_EPOCH + std::time::Duration::from_secs(1577836800); // 2020-01-01T00:00:00Z
        assert_eq!(converted_systemtime, expected);

        // Test another date (2023-07-15 12:30:45)
        let st2 = windows::Win32::Foundation::SYSTEMTIME {
            wYear: 2023,
            wMonth: 7,
            wDay: 15,
            wDayOfWeek: 0,
        ...
        let mut ft2 = windows::Win32::Foundation::FILETIME::default();
        unsafe {
            windows::Win32::System::Time::SystemTimeToFileTime(&st2, &mut ft2)
                .ok()
        ...
        let expected2 = UNIX_EPOCH + std::time::Duration::from_secs(1689424245);
